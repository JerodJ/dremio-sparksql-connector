...
@SourceType(value = "SparkSQLARP", label = "SparkSQL",uiConfig = "sparksql-layout.json")
public class SparkSQLConf extends AbstractArpConf<SparkSQLConf> {
  private static final String ARP_FILENAME = "arp/implementation/sparksql-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.sparksql.SparkSQLDriver";
